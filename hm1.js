...
/*
2)
Create a function to check two given numbers and return true if
 one of the number is 50 or if their sum is 50.
*/
const checkIsFifty = function (a, b) {
    if (a === 50 || b === 50 || a + b === 50) {
        return true
    } else {
        return false
...
console.log(removeChar("strive", 4))

/*4)
 Create a function to find the largest of three given integers.
*/
const findLargestInteger = function (...args) {
    const sorted = args.sort((a, b) => b - a)
    return sorted[0]
}
console.log(findLargestInteger(5, 9, 3))
/*
5)
...
console.log(createCopies("striveStudent", 5))
